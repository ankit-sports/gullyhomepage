...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.features-grid, .community-features, .diff-grid, .faq-grid').forEach(grid => {
...
// ==========================================
document.querySelectorAll('.feature-card, .community-card, .diff-card').forEach(card => {
